...
import java.io.Serializable;
	 ...
	 */
		public class DemoBean implements Serializable {
			...
			int id;	//TOUR DETAILS AND STUDENT
...
//GETTERS AND SETTERS 
			...
			public String getAnnualYr() {
				return annualYr;
			}
			public void setAnnualYr(String annualYr) {
				this.annualYr = annualYr;
			}
			...
			public int getId() {		//GETTER SETTER FOR ID 
				return id;
			}
...
// GETTER SETTER FOR TOUR DETAILS		
			public int getEmpId() {
				return empId;
			}
